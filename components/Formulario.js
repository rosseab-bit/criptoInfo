...
const Formulario=({moneda, criptomoneda, guardarMoneda, guardarCriptomoneda, guardarConsultarAPI})=>{
  ...
  // alamacena las seleciones del usuario
  ...
  const cotizarPrecio=()=>{
    ...
    //cambiar el status de consultarAPI
  ...
  return (
    <View>
      ...
      >
        ...
        <Picker.Item label="Peso Argentina" value="ARG" />
      ...
      >
        <Text style={styles.textoContizar}>Cotizar</Text>
      </TouchableHighlight>
    </View>
  );
};
